...
```bash
python3 mcp-agentic-rules/mcp.py <command>
```
...
1. Load context: `python3 mcp-agentic-rules/mcp.py autocontext`
2. Read README.md (single source of truth)
3. Identify tasks: `python3 mcp-agentic-rules/mcp.py todos`
...
1. **Before ANY coding task**, run:
   ```bash
   python3 mcp-agentic-rules/mcp.py autocontext
   ```

2. **Before modifying a file**, check impact:
   ```bash
   python3 mcp-agentic-rules/mcp.py impact <file>
   python3 mcp-agentic-rules/mcp.py predict-bugs <file>
   ```

3. **After making changes**, verify:
   ```bash
   python3 mcp-agentic-rules/mcp.py review <file>
   python3 mcp-agentic-rules/mcp.py security <file>
   ```

4. **Remember important decisions**:
   ```bash
   python3 mcp-agentic-rules/mcp.py remember "<key>" "<value>"
   ```

5. **Recall prior knowledge**:
   ```bash
   python3 mcp-agentic-rules/mcp.py recall "<query>"
   ```
